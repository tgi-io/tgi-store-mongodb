...
```
<blockquote><strong>log: </strong>Tue Jan 23 2018 14:05:37 GMT-0500 (EST)<br></blockquote>
...
```
<blockquote><strong>log: </strong>a MongoStore MongoStore<br><strong>log: </strong>0<br><strong>log: </strong>0<br><strong>log: </strong>Larry,Moe,Shemp<br>returns <strong>true</strong> as expected
</blockquote>
